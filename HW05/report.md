...
Таким образом, для того, чтобы в отчёте не "прыгали" данные при массовом и активном изменении данных, лучше перед его выполнением применять уровень изоляции транзакции Serializable.
Это будет гарантировать отсутствие "грязного" чтения и неконстистентных данных в разных таблицах.
И не забывать завершать транзакцию по окончании работы.
