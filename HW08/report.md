...
Взимная блокировка. Пусть Первая транзакция исправит1-ю строку, вторая - вторую строку, а потом первая - тоже вторую вторую.
Возникнет взаимна блокировка и Postgres должен выявить эту ситуацию и прервать 1 из транзакций.
