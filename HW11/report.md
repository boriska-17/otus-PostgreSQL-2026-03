...
Здесь мы видим, что сканирование происходит по секционированной таблице bookings.boarding_passes_03.
Стоимость этой операции заметно меньше (20627 против 140669 до санкционирования).
