...
(
	good_name   varchar(63) NOT NULL UNIQUE,
	sum_sale	numeric(16, 2)NOT NULL
);

-- Создадим триггер для поддержки: при изменениях в sales - обновлять good_sum_mart
...
Теперь добавим данные в исходные таблицы
